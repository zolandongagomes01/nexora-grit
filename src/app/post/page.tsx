      ...
      <main className="lg:ml-64 pt-14 lg:pt-0 pb-24 lg:pb-8 px-4 lg:px-8 py-6 max-w-2xl">
        ...
        <div className="space-y-5">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-4 bg-gradient-to-r from-[#4F8EF7] to-[#7C3AED] text-white font-semibold rounded-xl transition-all duration-200 hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
